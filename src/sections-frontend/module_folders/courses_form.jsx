    ...
    <div className="col-md-4 shadow rounded bg-light p-3">
        ...
        <form onSubmit={handleSubmit} className="d-flex flex-column gap-2 p-2">
            <div className="input-group">
              ...
              <input name="id" className="form-control" type="number" min={1}
            ...
            <div className="input-group">
              ...
              <input id="s1-sigla" name="sigla" className="form-control" type="text" placeholder="(Ej. MEAD, EACD...)" 
            ...
            <small>Se verá este Folio en "Cargar Archivos": 
                <b> {folderData.sigla.toUpperCase()}-##-{folderData.year} </b> 
            </small>
            
            <div>
               <button className="btn-member me-1" type="button" onClick={handleClear}>
